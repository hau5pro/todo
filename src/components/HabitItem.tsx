  ...
  return (
    ...
    >
      <AnimatedCheckbox
        ...
        habitId={id}
      />
      <span className="habit-item__title-wrap" data-tooltip={title}>
      ...
      {streak > 0 && (
        <span className={[
          'habit-item__streak',
          streak >= 7 ? 'habit-item__streak--hot' : '',
          !completedToday ? 'habit-item__streak--pending' : '',
        ].filter(Boolean).join(' ')} aria-label={`${streak} day streak`}>
